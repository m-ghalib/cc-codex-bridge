...
export function ensureCodexHooksEnabled(scope, projectRoot, userHome) {
    ...
    if (fs.existsSync(targetPath)) {
        ...
        try {
            ...
            throw new Error(`Codex config at ${targetPath} is not valid TOML: ${err.message}`);
        }
    }
...
function configPath(scope, projectRoot, userHome) {
    if (scope === "project")
