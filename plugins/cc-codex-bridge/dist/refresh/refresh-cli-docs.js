...
export const USER_AGENT = "cc-codex-bridge-refresh-cli-docs (+https://github.com/m-ghalib/cc-codex-bridge)";
...
export function shouldAttachGithubToken(url) {
    let parsed;
    try {
        parsed = new URL(url);
    }
...
export function writeSnapshot(dest, body) {
    fs.mkdirSync(path.dirname(dest), { recursive: true });
    fs.writeFileSync(dest, body);
}
function buildTasks(sources, snapshotRoot) {
    const tasks = [];
...
export async function refreshSources(opts = {}) {
