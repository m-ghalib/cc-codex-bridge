# cc-codex-bridge Public Release Prep — Design Spec
...
Prepare cc-codex-bridge for public sharing (GitHub, HN, LinkedIn) by adding the
...
|---|---|---|
| Title + badges | `# cc-codex-bridge` with MIT license badge, Python >=3.13, tests passing | 3 |
...
```json
{
  "author": "m-ghalib",
  "license": "MIT",
  "homepage": "https://github.com/m-ghalib/cc-codex-bridge",
  "repository": "https://github.com/m-ghalib/cc-codex-bridge",
...
**Change:** `github.com/mominabrarghalib/cc-codex-bridge` → `github.com/m-ghalib/cc-codex-bridge`
